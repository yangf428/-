...
<%@ page import="sun.jvm.hotspot.oops.Array" %>
<%@ page import="entity.Good" %>
<!DOCTYPE html>
<html lang="en">
<head>
	<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
	<title>东师拾遗--拾物管理</title>
      				...
      				<div class="span9">
      					...
      					<div class="widget widget-table">
							...
							<%
								...
								ArrayList<Good> adFoundList= goodService.getGoodsAdFound();
								Good good;
							...
							%>
      						<div class="widget-content">
      							<table  class="table table-striped table-bordered">
									...
									<%
										for (int i=0;i<adFoundList.size()-1;i++){
											good = adFoundList.get(i);
											//净月是1，本部是0
