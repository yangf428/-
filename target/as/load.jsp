...
<body>
	...
	<main class="sign">
		<div class="col-md-6 col-lg-6 col-md-offset-3 col-lg-offset-3 sign_h">
			<div class="sign_out">
				<div class="sign_left">
					<h2 style="font-family: '楷体';font-size: 35px;">友情提示</h2>
					<br>
				...
				<div class="sign_right">
					...
					<!-- 表单部分 -->
					<form id="defaultForm" method="post" class="form-horizontal" action="/load">
						...
						<div class="form-group">
							<div class="col-lg-9 col-lg-offset-3">
								<button class="btn btn-info" id="validateBtn"  onclick="this.form.submit()">登录</button>
							</div>
						</div>
		...
		<div class="footer">
			...
			<p>Contact information: <a href="#">someone@nenu.edu.cn</a>.</p>
		</div>
